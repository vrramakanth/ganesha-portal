...
export const api = {
  ...
  volunteer: {
    ...
    adminCancelCommunityDinnerRegistration: (idToken: string, registrationId: string, reason: string) =>
      apiPost<{ registrationId: string; status: string }>("volunteer.communityDinner.adminCancel", {
        idToken,
        registrationId,
        reason,
      }),
    ...
    deleteExpense: (idToken: string, expenseId: string, reason: string) =>
      apiPost<{ expenseId: string; status: string }>("volunteer.expenses.delete", { idToken, expenseId, reason }),
